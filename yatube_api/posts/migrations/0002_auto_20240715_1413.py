# Generated by Django 3.2.16 on 2024-07-15 11:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='posts.post', verbose_name='Комментируемыая публикация'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='text',
